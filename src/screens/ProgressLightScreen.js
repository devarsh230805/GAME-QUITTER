    ...
    <View style={styles.container}>
      ...
      <View style={styles.achRow}>
        <View style={styles.badge}>
          <Text style={styles.badgeText}>One Week</Text>
        </View>
        <View style={styles.badge}>
          <Text style={styles.badgeText}>Two Weeks</Text>
        </View>
      </View>
      <View style={styles.achRow}>
        <View style={styles.badge}>
          <Text style={styles.badgeText}>One Month</Text>
        </View>
        <View style={[styles.badge, { opacity: 0.4 }]}>
          <Text style={styles.badgeText}>Two Months</Text>
        </View>
      </View>
    </View>
  );
